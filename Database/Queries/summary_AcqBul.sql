SELECT vendor,name,patchname,prvpatch,device_count,prodfamily,severity,status,preference,type,date_posted,architecture ,acqisition_status,bulletin,prodid,patchuid,sqnumber,lang_name,languagecode,language
...
SELECT 
  a.patchname ,a.prvpatch,pb.title,pb.vendor_info_page, count(distinct(a.device_id)) as device_count,
   (CASE to_char(a.severity) 
    ...
    paq.status ,
 a.patchtyp as type,
 pb.date_posted,pd.architecture , a.prodfamily,
...
,a.bulletin,a.prodfamily,a.prodid,a.name,a.patchuid,a.vendor,a.sqnumber,a.language,l.lang_name,l.languagecode) t1 <<OUTERFILTERSTRING>> AND acqisition_status='Yes'