SELECT vendor,name,patchname,prvpatch,device_count,prodfamily,severity,status,type,preference,date_posted,architecture ,acqisition_status,bulletin,prodid,patchuid,sqnumber,lang_name,languagecode,language
