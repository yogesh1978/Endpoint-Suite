SELECT vendor,name,patchname,prvpatch,device_count,prodfamily,severity,status,type,preference,date_posted,architecture ,acqisition_status,bulletin,prodid,patchuid,sqnumber,languagecode,lang_name,language
