SELECT severity as category , count(severity) as count
FROM  (
SELECT 
...
,a.bulletin,a.prodfamily,a.prodid,a.name,a.patchuid,a.vendor,a.sqnumber,a.language,l.lang_name,l.languagecode) t1 group by severity